...
public class ExcelReader {
  ...
  // returns true if data is set successfully else false
  public boolean setCellData(final String sheetName, final String colName, final int rowNum,
      final String data, final String url) {
    logger.debug("setCellData setCellData******************");
    try {
      fis = new FileInputStream(path);
      workbook = new XSSFWorkbook(fis);
  ...
  // message
  public boolean addHyperLink(final String sheetName, final String screenShotColName,
      final String testCaseName, final int index, String url, final String message) {
    logger.debug("ADDING addHyperLink******************");
