...
import com.demoqa.utils.MyReporterUtils;
...
public class ExtentReporterNG implements IReporter {
	...
	public void generateReport(final List<XmlSuite> xmlSuites, final List<ISuite> suites,
		...
		File destDir = new File(resultPath + File.separator + GenericConstants.SCREEN_SHOT_FOLDER);
		try {
		...
		int passedTest = 0;
		int failedTest = 0;
		File file = new File(resultPath + File.separator + GenericConstants.EXTENT_REPORT_FILE_NAME);
		try {
