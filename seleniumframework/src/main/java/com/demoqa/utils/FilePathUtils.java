...
public class FilePathUtils {
  ...
  public static String getFullPathOfFileFromClassPath(final String browserImplExeFileName) {
    String filePath =
        FilePathUtils.class.getClassLoader().getResource(browserImplExeFileName).getFile();
    return filePath;
  }
  ...
  public static void main(final String[] args) {
    System.out
        .println("main method " + FilePathUtils.getFullPathOfFileFromClassPath("chromedriver.exe"));
  }
