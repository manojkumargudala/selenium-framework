...
public class FilePathUtils {
	private static Logger logger = LogManager.getLogger(FilePathUtils.class);
	...
	public static String getDriverFullPath(final String browserName) {
		String filePath = "";
		if (FilePathUtils.class.getClassLoader().getResource(browserName) != null) {
			filePath = FilePathUtils.class.getClassLoader().getResource(browserName).getFile();
		} else {
			filePath = FilePathUtils.class.getClassLoader().getResource(browserName + ".exe").getFile();
		}
	...
	public static void main(final String[] args) {
		System.out.println("main method " + FilePathUtils.getFullPathOfFileFromClassPath("chromedriver.exe"));
	}
